  ...
  return (
    <div className="w-full animate-fade-in flex flex-col items-center lg:items-start">
        ...
        <form className="space-y-5">
          ...
          <div className="form-control group">
            <div className="flex justify-between items-center mb-2 ml-1">
              ...
              <Link href="#" className="text-xs font-bold text-primary hover:underline pr-1">Lupa sandi?</Link>
            </div>
            <input 
              type="password" 
              placeholder="••••••••"
      ...
      <p className="text-sm text-on-surface-variant mt-10 text-center lg:text-left w-full">
        Belum punya akun? {" "}
        <Link href="/auth/register" className="font-bold text-primary hover:underline">Daftar Gratis</Link>
      </p>
    </div>
  );
}

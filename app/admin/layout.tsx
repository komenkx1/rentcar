...
const SIDEBAR_ITEMS = [
  ...
  { href: "/admin/kendaraan", label: "Armada", icon: "directions_car" },
  { href: "/admin/pesanan", label: "Pesanan", icon: "receipt_long" },
  { href: "/admin/pembayaran", label: "Pembayaran", icon: "payments" },
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="lg:hidden fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-xl border-b border-outline-variant/20 h-14 flex items-center px-4 gap-3">
        ...
        <span className="font-headline font-bold text-on-surface">Admin Panel</span>
      </div>
        ...
        <div className="p-4 border-b border-outline-variant/20">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-outline">Admin Panel</p>
            </div>
          </div>
        </div>
